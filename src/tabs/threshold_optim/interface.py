...
with gr.Blocks() as app:
    ...
    with gr.Column(visible=False) as inputs_outputs:
        ...
        with gr.Row():
            with gr.Column():
                ...
                decoder_false_low_perception_rate = gr.Textbox(label="Rate of Lick Prediction Miss", interactive=False,value='')
                decoder_false_high_perception_rate = gr.Textbox(label="Rate of Lick Prediction False Alarm", interactive=False,value='')
            with gr.Column():
                gr.Markdown('## Behavior Optimized')
                behavior_false_low_perception_rate = gr.Textbox(label="Rate of Lick Prediction Miss", interactive=False,value='')
                behavior_false_high_perception_rate = gr.Textbox(label="Rate of Lick Prediction False Alarm", interactive=False,value='')
        with gr.Column():
    ...
    decoder_metrics = [decoder_false_low_perception_rate,decoder_false_high_perception_rate]
    behavior_metrics = [behavior_false_low_perception_rate,behavior_false_high_perception_rate]
